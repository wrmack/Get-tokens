...
class AuthorizationRequest: NSObject, Codable  {
    ...
    init(configuration: ProviderConfiguration?, clientId clientID: String?, clientSecret: String?, scope: String?, redirectURL: URL?, responseType: String?, state: String?, nonce: String?, codeVerifier: String?, codeChallenge: String?, codeChallengeMethod: String?, additionalParameters: [String : AnyCodable]?) {
        super.init()
    ...
    convenience init(configuration: ProviderConfiguration?, clientId clientID: String?, clientSecret: String?, scopes: [String]?, redirectURL: URL?, responseType: String?, additionalParameters: [String : AnyCodable]?) {
    ...
    convenience init(configuration: ProviderConfiguration?, clientId clientID: String?, scopes: [String]?, redirectURL: URL?, responseType: String?, additionalParameters: [String : AnyCodable]?) {
        self.init(configuration: configuration, clientId: clientID, clientSecret: nil, scopes: scopes, redirectURL: redirectURL, responseType: responseType, additionalParameters: additionalParameters)
    }
